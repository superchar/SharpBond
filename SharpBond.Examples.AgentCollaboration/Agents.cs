...
public class PoemAgent(ISessionStorage sessionStorage, IMessageRuntime messageRuntime)
    : Agent(sessionStorage,
        messageRuntime), IHandles<AgentState, RequestPoem>
{
...
public class SummarizationAgent(ISessionStorage sessionStorage, IMessageRuntime messageRuntime)
    : Agent(sessionStorage,
        messageRuntime), IHandles<AgentState, RequestSummarization>
{
...
public class ReviewerAgent(ISessionStorage sessionStorage, IMessageRuntime messageRuntime)
    : Agent(sessionStorage,
        messageRuntime), IHandles<AgentState, RequestReview>
{
...
public class OrchestratorAgent(ISessionStorage sessionStorage, IMessageRuntime messageRuntime)
    : Agent(sessionStorage,
            messageRuntime), IHandles<AgentState, StartWorkflow>, IHandles<AgentState, PoemResponse>,
